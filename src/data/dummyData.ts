...
export const sampleMultipleResult: QuizStore['quizData'] = [
  {
    question: 'JavaScript에서 변수를 선언할 때 사용하는 키워드는 무엇인가요?',
    options: ['var', 'let', 'const', 'var, let, const 모두'],
    answer: 'var, let, const 모두',
...
export const sampleTrueFalseResult: QuizStore['quizData'] = [
  {
    question: 'JavaScript는 웹 페이지의 레이아웃을 담당하는 스타일 시트 언어이다.',
    answer: false,
    userAnswer: false,
...
export const sampleFillBlankResult: QuizStore['quizData'] = [
  {
    question: 'JavaScript에서 변수를 선언할 때 사용하는 키워드는 _____이다.',
    answer: ['let', '변수'],
    userAnswer: 'let',
